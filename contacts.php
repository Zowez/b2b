                                        ...
                                        <div class="uk-child-width-1-1 uk-child-width-1-2@s uk-margin-top" uk-grid>
                                            <section>
                                                ...
                                                <ul class="uk-list">
                                                    ...
                                                    <li>
                                                        <div><span class="uk-margin-small-right" uk-icon="location"></span><span>St.&nbsp;Petersburg, Nevsky&nbsp;Prospect&nbsp;28</span></div>
                                                    </li>
                                                    <li>
                                                        <div><span class="uk-margin-small-right" uk-icon="clock"></span><span>Daily 10:00–22:00</span></div>
                                                    </li>
                                                </ul>
                                            </section>
                                            <section>
